const ProductCard = ({ image, subtitle, title, price }) => {
    return (
      <div className="w-[400px] min-h-[300px] p-4   rounded-md text-center hover:bg-white mx-auto">
        ...
        <button className="bg-white mt-2 w-[250px] px-4 py-2 border-[1px] border-textHeader text-textHeader rounded-md transition-all duration-300 ease-in-out hover:!bg-textHeader hover:!text-white">
        Add to Cart
      </button>
